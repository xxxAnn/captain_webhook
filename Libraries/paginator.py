...
class PagesFromMessage:
    ...
    permissions: discord.Permissions
        Our permissions for the channel.
    """
    def __init__(self, bot, message, *, entries, per_page=12, show_entry_count=True, custom_title):
        self.bot = bot
        self.entries = entries
        ...
        if message.guild is not None:
            self.permissions = self.channel.permissions_for(message.guild.me)
        else:
            self.permissions = self.channel.permissions_for(bot.user)
